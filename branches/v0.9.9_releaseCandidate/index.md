...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/dak-srv/ImplementationGuide/smart.who.int.dak-srv | *Version*:0.9.9 |
| Active as of 2026-02-16 | *Computable Name*:DAKSRV |
...
```json
{
  ...
  "id" : "smart.who.int.dak-srv",
  "meta" : {
    "profile" : ["SMARTImplementationGuide"]
  },
  "url" : "http://smart.who.int/dak-srv/ImplementationGuide/smart.who.int.dak-srv",
  "version" : "0.9.9",
  "name" : "DAKSRV",
  "title" : "SMART DAK SRV",
  "status" : "active",
  "date" : "2026-02-16T14:16:38+00:00",
  "publisher" : "WHO",
  "contact" : [
    {
      "name" : "WHO",
  ...
  "description" : "Surveillance Digital Adaptation Kit (DAK) Implementation Guide for publishing SMART DAK content for infectious disease surveillance",
  "packageId" : "smart.who.int.dak-srv",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [
    {
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://smart.who.int/dak-srv/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
