...
Digital Adaptation Kit (DAK) for Surveillance.

The decision-support logic component provides the decision logic and
algorithms in accordance with the recommendations within the Surveillance guidelines and guidance and deconstruct them into a machine readable format that clearly labels the
